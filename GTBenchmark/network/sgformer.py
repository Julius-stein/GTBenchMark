...
from GTBenchmark.network.trans_conv import TransConv


from torch_geometric.nn import Sequential
import GTBenchmark.graphgym.register as register
from GTBenchmark.graphgym.models.layer import  GCNConv, Linear
        ...
        if cfg.gt.use_graph:
            if cfg.gt.aggregate == 'add':
                self.model=Sequential('x',[
                    ...
                    (GCNConv(dim_in=cfg.gt.dim_hidden, dim_out=cfg.gt.dim_hidden, num_layers=1, has_act=True, has_bias=True), 'x -> x2'),
