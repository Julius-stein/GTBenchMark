...
from GTBenchmark.layer.difformer_layer import DIFFormerConv


from torch_geometric.nn import Sequential
import GTBenchmark.graphgym.register as register
from GTBenchmark.graphgym.models.layer import GeneralLayer, GCNConv, Linear
...
class DIFFormer(nn.Module):
    ...
    def __init__(self, dim_in, dim_out):
        ...
        self.pre_mp = GeneralLayer('linear', dim_in = dim_in, dim_out = cfg.gt.dim_hidden, num_layers = 1, has_act = True, has_bias = True)
