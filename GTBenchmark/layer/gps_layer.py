...
class GPSLayer(nn.Module):
    ...
    def __init__(self, dim_h,
        ...
        # MPNNs without edge attributes support.
            ...
            self.local_model = pygnn.GCNConv(dim_h, dim_h,add_self_loops=True)
        ...
        # MPNNs supporting also edge attributes.
            ...
            self.local_model = pygnn.GATConv(in_channels=dim_h,
                                             out_channels=dim_h // self.num_heads,
        ...
        # Feed Forward block.
        self.ff_linear1 = nn.Linear(dim_h, self.ffn_dim)
        self.ff_linear2 = nn.Linear(self.ffn_dim, dim_h)
    ...
    def forward(self, batch, TransGene):
        h = batch.x
        ...
        # h = sum(h_out_list)
        h = torch.stack(h_out_list, dim=0).sum(dim=0)
    ...
    def _sa_block(self,batch,mask):
        batch = self.self_attn(batch,mask) 
        return batch
