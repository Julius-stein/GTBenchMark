...
from GTBenchmark.encoder.raw_encoder import (RawNodeEncoder, RawEdgeEncoder)
from GTBenchmark.encoder.hetero_raw_encoder import (HeteroRawNodeEncoder, HeteroRawEdgeEncoder)
from GTBenchmark.encoder.voc_superpixels_encoder import VOCNodeEncoder

from GTBenchmark.encoder.laplace_pos_encoder import LapPENodeEncoder
from GTBenchmark.encoder.homo_gnn_encoder import HomoGNNEncoder
from GTBenchmark.encoder.hetero_gnn_encoder import HeteroGNNEncoder
from GTBenchmark.encoder.hetero_label_encoder import HeteroLabelNodeEncoder
from GTBenchmark.encoder.hetero_pos_encoder import (Node2VecNodeEncoder, MetapathNodeEncoder,\
                                             TransENodeEncoder, ComplExNodeEncoder, DistMultNodeEncoder)
from GTBenchmark.encoder.hetero_distance_encoder import (HeteroDistanceAttentionBias, \
